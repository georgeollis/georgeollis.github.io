...
![Azure Virtual Network Manager - Controlling virtual networks at scale](/images/blog/azure-virtual-network-manager-at-scale/avnm-oerview-2.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-1.png)

Let's go ahead and deploy our virtual network manager resource. Deploying the resource is pretty straightforward.

![](/images/blog/azure-virtual-network-manager-at-scale/image-2.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/AVNM-1.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-3.png)

Full Mesh Topology

![](/images/blog/azure-virtual-network-manager-at-scale/image-4.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-9.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-10.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/AVNM-Network-Groups.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-11.png)

2\. Select our static network group and click **group members.**

![](/images/blog/azure-virtual-network-manager-at-scale/image-12.png)

3\. Click add and then **manually add members.**

![](/images/blog/azure-virtual-network-manager-at-scale/image-15.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-16.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-21.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/virtual-network-manager.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-22.png)

Selecting the **policies** on the left screen shows us the policy that has been assigned and its scope.

![](/images/blog/azure-virtual-network-manager-at-scale/image-23.png)

Clicking on the policy will allow you to change the configuration.

![](/images/blog/azure-virtual-network-manager-at-scale/image-24.png)

However, you can also go to **Azure Policy** and view the resource configuration entirely.

![](/images/blog/azure-virtual-network-manager-at-scale/image-25.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-26.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-27.png)

For our example, we shall use the mesh topology. Let's select the dynamic network group we created early.

![](/images/blog/azure-virtual-network-manager-at-scale/image-28.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-29.png)

The above screenshot shows our configuration is complete. Now let's go to **deployments** on the left.

![](/images/blog/azure-virtual-network-manager-at-scale/image-30.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-34.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-35.png)

The configuration is now completed. How do we test this configuration?

![](/images/blog/azure-virtual-network-manager-at-scale/image-36.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-37.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-38.png)

We can confirm we can communicate! Let's have a look at the virtual network to review the connection.

![](/images/blog/azure-virtual-network-manager-at-scale/image-39.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-42.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-43.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-44.png)

Let's wait for the network group count from 10 to 9, indicating that vnet-1 has been dynamically removed.

![](/images/blog/azure-virtual-network-manager-at-scale/image-45.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-50.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-51.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-52.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-53.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-54.png)

Go to deployments and select deploy configurations.

![](/images/blog/azure-virtual-network-manager-at-scale/image-55.png)

Select the security admin configuration we created and click review and deploy.

![](/images/blog/azure-virtual-network-manager-at-scale/image-56.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-59.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-60.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-63.png)

We've blocked NSG traffic to port 22 on the **default** subnet in vnet-10.

![](/images/blog/azure-virtual-network-manager-at-scale/image-64.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-67.png)

What if we change the AVNM security configuration again from **Allow** to **Always Allow** instead?

![](/images/blog/azure-virtual-network-manager-at-scale/image-68.png)

![](/images/blog/azure-virtual-network-manager-at-scale/image-69.png)

We've confirmed the setting has been applied; let's rerun our test.

![](/images/blog/azure-virtual-network-manager-at-scale/image-70.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-74.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-75.png)
...
![](/images/blog/azure-virtual-network-manager-at-scale/image-76.png)
